...
class HelionLib
{
     ...
     * @param int $cyfra Dodatkowy parametr, pozwalaj¹cy dok³adniej ledziæ konwersje. Zakres 0-255.
    ...
    /**
     * Zwraca liczbê odpowiadaj¹c¹ procentowej wysokoci zni¿ki na podan¹ ksi¹¿kê.
     *
